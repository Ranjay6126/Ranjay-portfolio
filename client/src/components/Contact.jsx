    ...
    <section id="contact" className="py-4 sm:py-6 px-4 sm:px-6 min-h-0 md:min-h-screen flex items-center flex-col relative overflow-hidden">
      ...
      <footer className="w-full mt-6 sm:mt-8 md:mt-9 text-center text-xs sm:text-sm" style={{ color: "var(--text-primary)" }}>
        ...
        <div className="flex justify-center gap-5 sm:gap-8 mb-4 sm:mb-6">
          ...
          <a href="https://x.com/Ranjay10220" target="_blank" rel="noopener noreferrer" className="transition-colors hover:opacity-70" style={{ color: "var(--text-primary)" }}>
            <FaXTwitter className="text-2xl sm:text-3xl" />
          </a>
          <a href="https://www.instagram.com/er.ranjay_prajapati/" target="_blank" rel="noopener noreferrer" className="transition-colors hover:opacity-70" style={{ color: "var(--text-primary)" }}>
            <FaInstagram className="text-2xl sm:text-3xl" />
          </a>
          <a href="https://www.linkedin.com/in/ranjay-pandit-prajapati/" target="_blank" rel="noopener noreferrer" className="transition-colors hover:opacity-70" style={{ color: "var(--text-primary)" }}>
