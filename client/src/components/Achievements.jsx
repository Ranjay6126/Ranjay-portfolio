...
export default function Achievements({ achievements = [] }) {
  ...
  return (
    <section id="achievements" className="min-h-screen flex py-10 flex-col items-center relative overflow-hidden">
          ...
          {achievements.map((ach, i) => (
            ...
            >
              <div className="flex justify-between items-start mb-4">
                <h3 className="text-xl font-bold text-white group-hover:text-indigo-400">{ach.title}</h3>
                <span className="text-xs text-indigo-300 bg-indigo-500/10 px-3 py-1 rounded-full">{ach.date}</span>
              </div>
