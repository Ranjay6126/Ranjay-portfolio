  ...
  return (
    <div className="fixed inset-0 z-[-1] bg-black">
      <Canvas camera={{ position: [0, 0, 1] }} dpr={[1, 1.5]} gl={{ antialias: false, powerPreference: "high-performance" }}>
        {/* Cap pixel density and particle count so the background stays smooth on mobile GPUs. */}
        <Stars radius={300} depth={50} count={2500} factor={4} saturation={0} fade speed={1} />
