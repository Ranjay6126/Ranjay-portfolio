...
export default function Services() {
  ...
  return (
    <section 
      id="services" 
      className="min-h-0 sm:min-h-[144vh] lg:min-h-[132vh] flex items-center justify-center relative overflow-hidden px-4 py-6 pb-4 sm:px-6 sm:py-8 md:py-6"
    >
      ...
      <motion.div
        ...
        className="pointer-events-auto portfolio-card bg-white/5 backdrop-blur-2xl border border-white/10 p-5 sm:p-10 md:p-14 rounded-3xl sm:rounded-[2.5rem] max-w-6xl md:max-w-7xl w-full relative z-10 shadow-2xl"
      >
        <motion.div
