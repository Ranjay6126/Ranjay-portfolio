...
export default function Projects() {
  ...
  return (
    <section
      id="projects"
      className="relative flex min-h-0 md:min-h-[80vh] flex-col items-center px-4 pb-4 pt-2 sm:px-6 sm:pt-5 sm:pb-6 md:pt-7 md:pb-7 lg:pt-8 lg:pb-8 overflow-hidden"
    >
